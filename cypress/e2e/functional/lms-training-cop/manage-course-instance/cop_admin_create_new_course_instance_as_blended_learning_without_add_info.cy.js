...
describe(Epic.LmsTrainingCop, () => {
  ...
  before(() => {
    yamlHelper.read().then(({ CourseData, CreateEmptyInstances }) => {
      ...
      instance = CreateEmptyInstances.blendedLearning
  ...
  context(Story.manageCourseInstance, () => {
    it('CoP Admin create new course instance as Blended Learning without add info', () => {
      Story.ticket('QA-912')
      ...
      cy.logInTestCase('CoP admin create Blended course instance without add info')
      copManageInstance.goToCreateInstance(courseId)
      copManageInstance.getDeliveryMethod('Blended Learning').click()
