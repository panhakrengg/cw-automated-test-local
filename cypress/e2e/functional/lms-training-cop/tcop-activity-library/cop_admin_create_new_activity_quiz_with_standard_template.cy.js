  ...
  context(Story.tCopActivityLibrary, () => {
    ...
    before(() => {
      activityLibraryBase.yaml.getTCopForActivityLibraryCop((data) => {
        cop = data
        activity = cop.activityLibrary.auTCActivityQuiz
        activityTitle = activity.title
      })
    })

    it('CoP Admin creates new activity Quiz with Activity Template - CoP Library', () => {
      Story.ticket('QA-1598')
      ...
      activityLibraryBase.orgActions.createNewQuizActivity(activity)
      ...
      activityLibraryBase.orgAssertions.expectToSeeNewQuizActivityInLibrary(activity)
    })
  })
})
