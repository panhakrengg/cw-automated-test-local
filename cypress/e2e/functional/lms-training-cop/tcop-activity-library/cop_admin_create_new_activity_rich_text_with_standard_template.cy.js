  ...
  context(Story.tCopActivityLibrary, () => {
    ...
    before(() => {
      activityLibraryBase.yaml.getTCopForActivityLibraryCop((data) => {
        cop = data
        activity = cop.activityLibrary.auSCActivityRichText
        activityTitle = activity.title
      })
    })

    it('CoP Admin creates new activity Rich Text - CoP Library', () => {
      Story.ticket('QA-1595')
      ...
      activityLibraryBase.orgActions.createNewRichTextActivity(activity)
      ...
      activityLibraryBase.orgAssertions.expectToSeeNewRichTextActivityInLibrary(activity)
    })
  })
})
