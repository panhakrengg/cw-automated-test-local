...
describe(Epic.CoPAdministration, () => {
  ...
  context(Story.communityManageMembers, () => {
    ...
    it('CoP Admin invite non-cw user via email the user check registration screen - TCoP', () => {
      Story.ticket('QA-664')
      ...
      manageMemberAssertion.verifyRegistrationScreen(cop.name.value, nonCwUser.email, true)
    })
  })
})
