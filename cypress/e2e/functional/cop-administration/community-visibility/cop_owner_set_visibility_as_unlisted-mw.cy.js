...
describe(Epic.CoPAdministration, () => {
  ...
  context(Story.communityVisibility, () => {
    it('CoP Owner set visibility as Unlisted - MW', () => {
      Story.ticket('QA-564')
      adminSettings.setUrl(coPAdminMock.getMWCoPFuncUnlistedAdminUrl())
      ...
      communityVisibility.expectCopFoundWithUnlistedLabel(coPAdminMock.getMWCoPFuncUnlistedName())
    })
  })
})
