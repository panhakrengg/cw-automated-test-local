...
describe(Epic.CoPAdministration, () => {
  ...
  context(Story.communityVisibility, () => {
    it('CoP Owner set visibility as Unlisted - Training', () => {
      Story.ticket('QA-752')
      adminSettings.setUrl(coPAdminMock.getTCoPFuncUnlistedAdminUrl())
      ...
      communityVisibility.expectCopFoundWithUnlistedLabel(coPAdminMock.getTCoPFuncUnlistedName())
    })
  })
})
