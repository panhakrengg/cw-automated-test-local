...
describe(Epic.CoPAdministration, () => {
  ...
  context(Story.communityVisibility, () => {
    it('CoP Owner set visibility as Unlisted - Org', () => {
      Story.ticket('QA-750')
      adminSettings.setUrl(coPAdminMock.getOrgCoPFuncUnlistedAdminUrl())
      ...
      communityVisibility.expectCopFoundWithUnlistedLabel(coPAdminMock.getOrgCoPFuncUnlistedName())
    })
  })
})
