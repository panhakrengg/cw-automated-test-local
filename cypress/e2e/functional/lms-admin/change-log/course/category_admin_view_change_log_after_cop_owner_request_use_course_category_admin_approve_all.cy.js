...
describe(Epic.LmsAdmin, () => {
  ...
  context(Story.lmsChangeLogCourse, () => {
    before(() => {
      ...
      yaml.getRequestThenApproveAllInstances((course) => {
    ...
    it('Category admin view Change Log after Cop owner Request to Use share course and Category admin Approve all instances', () => {
      Story.ticket('QA-2224')
      ...
      actionCommunitySharing.approveCommunityWithAllInstances(tCopName, copOwnerFullName)
