...
describe(Epic.LmsAdmin, () => {
  ...
  before(() => {
    cy.stubCourse(
      ...
      courseObj = course
      instanceObj = courseObj.instanceArchiveFileLog
      activity = instanceObj.activities.sOActivityFileArchiveLog
    })
  })

  context(Story.lmsChangeLogActivityLibrary, () => {
    it('Setup instance "Instance archive file activity then check log"', () => {
