...
describe(Epic.LmsAdmin, () => {
  ...
  before(() => {
    new YamlHelper('lms-admin/lms-change-log/log-instance')
      .read()
      .then(({ PublishUnpublishInstance }) => {
        courseObj = PublishUnpublishInstance.courseFuncInstanceLog
        instanceObj = courseObj.instanceForPublishLog
      })
  })

  context(Story.lmsChangeLogCourseInstance, () => {
    it('Setup instance "Instance for publish & unpublish to check log"', () => {
