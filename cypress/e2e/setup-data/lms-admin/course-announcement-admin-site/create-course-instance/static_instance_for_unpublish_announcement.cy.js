...
describe(Epic.LmsAdmin, () => {
  ...
  context(Story.courseAnnouncementAdminSite, () => {
    it('Setup instance "Static Instance for checking unpublish announcement"', () => {
      setupInstance.setCourseBaseYaml('courseFuncUnpublishAnnouncement')
      setupInstance.setInstanceBaseYaml('staticInstanceForUnpublishAnnouncement')
