...
describe(Epic.LmsAdmin, () => {
  ...
  context(Story.courseAnnouncementAdminSite, () => {
    it('Setup instance "Static Instance for checking remove announcement"', () => {
      setupInstance.setCourseBaseYaml('courseFuncRemoveAnnouncement')
      setupInstance.setInstanceBaseYaml('staticInstanceForRemoveAnnouncement')
