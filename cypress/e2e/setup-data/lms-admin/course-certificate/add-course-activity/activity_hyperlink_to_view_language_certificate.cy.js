...
describe(Epic.LmsAdmin, () => {
  ...
  context(Story.courseCertificate, () => {
    it('Setup activity "Beginner Tennis Lesson" to view language certificate course', () => {
      setupActivity.setCourseBaseYaml('courseFuncModifyLanguage')
      setupActivity.setInstanceBaseYaml('funcInstanceViewLanguage')
