...
describe(Epic.LmsAdmin, () => {
  ...
  context(Story.courseCertificate, () => {
    it('Setup activity "Beginner Tennis Lesson" to enable certificate course', () => {
      setupActivity.setCourseBaseYaml('courseFuncEnableCertificate')
      setupActivity.setInstanceBaseYaml('funcInstanceCompletedSeeCertificate')
