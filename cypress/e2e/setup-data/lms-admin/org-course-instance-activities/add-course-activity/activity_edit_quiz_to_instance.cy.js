...
describe(Epic.LmsAdmin, () => {
  ...
  context(Story.organizationCourseInstanceActivities, () => {
    it('Setup activity "tOActivityQuizInstanceEdit" to instance', () => {
      setupActivity.setCourseBaseYaml('courseFuncActivityFromLibrary')
      setupActivity.setInstanceBaseYaml('funcTOActivityQuizInstanceEdit')

      setupActivity.addActivityFromLibrary('tOActivityQuizInstanceEdit')
    })
  })
})
