...
describe(Epic.LmsAdmin, () => {
  ...
  context(Story.organizationCourseInstanceActivities, () => {
    it('Setup activity "tOActivityHyperlinkArchive" to instance', () => {
      setupActivity.setCourseBaseYaml('courseFuncActivityFromLibrary')
      setupActivity.setInstanceBaseYaml('funArchiveUnarchiveActivity')

      setupActivity.addActivityFromLibrary('tOActivityHyperlinkArchive')
    })
  })
})
