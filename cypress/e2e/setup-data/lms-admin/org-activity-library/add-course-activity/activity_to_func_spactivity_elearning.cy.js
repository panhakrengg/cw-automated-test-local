...
describe(Epic.LmsAdmin, () => {
  ...
  context(Story.organizationCourseInstanceActivities, () => {
    it('Setup activity "sOActivityElearningEdit" to instance', () => {
      setupActivity.setCourseBaseYaml('courseFuncActivityFromLibrary')
      setupActivity.setInstanceBaseYaml('funcSOActivityElearningEdit')

      setupActivity.addActivityFromLibrary('sOActivityElearningEdit')
    })
  })
})
