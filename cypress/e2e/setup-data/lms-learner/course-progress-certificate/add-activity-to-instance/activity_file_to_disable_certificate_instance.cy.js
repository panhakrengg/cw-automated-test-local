...
describe(Epic.LmsLearner, () => {
  ...
  before(() => {
    setupActivity.setDisableCertificateYaml()
  ...
  context(Story.courseProgressCertificate, () => {
    it('Setup activity "tOActivityDocWarmUp" to instance', () => {
      setupActivity.setCourseBaseYaml('progressOnDisableCertificate')
      setupActivity.setInstanceBaseYaml('instanceNotAwardCertificate')
