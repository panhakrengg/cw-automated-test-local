...
describe(Epic.LmsLearner, () => {
  ...
  before(() => {
    setupActivity.setRetakeCoursesYaml()
  ...
  context(Story.courseProgressCertificate, () => {
    it('Setup activity "tOActivityImage" to retake instance', () => {
      setupActivity.setCourseBaseYaml('courseFuncRetake')
      setupActivity.setInstanceBaseYaml('instanceCompleteRetake')
