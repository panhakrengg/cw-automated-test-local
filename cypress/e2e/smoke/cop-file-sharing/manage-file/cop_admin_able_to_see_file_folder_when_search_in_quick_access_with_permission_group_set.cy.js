...
describe(Epic.CoPFileSharing, () => {
  ...
  context(Story.manageFile, () => {
    it('Cop Admin able to see file folder when search in quick access with permission group set', () => {
      Story.ticket('QA-887')
      ...
      context('Navigate to Quick Access folder then search', () => {
      ...
      context('Search File And Search Folder', () => {
